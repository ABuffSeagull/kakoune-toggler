#ifndef cpptoml_h_INCLUDED
#define cpptoml_h_INCLUDED
...
template <>
inline typename array_of_trait<array>::return_type
table::get_qualified_array_of<array>
(const std::string &key) const {
	if (auto v = get_array_qualified(key)) {
		std::vector<std::shared_ptr<array>> result;
		result.reserve(v->get().size());
...
template <class OnError>
consumer<OnError>
make_consumer(std::string::iterator &it,
...
class parser {
 ...
 private:
	...
	std::shared_ptr<base>
	parse_value(std::string::iterator &it,
	...
	std::string::iterator
	find_end_of_number(std::string::iterator it,
	                   std::string::iterator end) {
	...
	std::string::iterator
	find_end_of_date(std::string::iterator it,
	                 std::string::iterator end) {
	...
	std::string::iterator
	find_end_of_time(std::string::iterator it,
	                 std::string::iterator end) {
	...
	local_time
	read_time(std::string::iterator &it,
	          const std::string::iterator &end) {
	...
	std::shared_ptr<base>
	parse_array(std::string::iterator &it,
	            std::string::iterator &end) {
